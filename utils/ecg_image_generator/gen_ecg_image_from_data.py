...
def get_parser():
    ...
    parser.add_argument("-l", "--link", type=str, required=False, default="https://www.physionet.org/content/ptbdb/1.0.3/")
    ...
    for out in out_array:
        ...
        if augment:
            ...
            out = get_augment(
                ...
                temperature=temp,
                bbox=args.bbox,
                store_text_bounding_box=args.store_text_bounding_box,
            )
