...
from helper_functions import convert_bounding_boxes_to_dict, read_leads, rotate_bounding_box, rotate_points
...
def get_augment(
    ...
    if bbox or store_text_bounding_box:
        json_dict["leads"] = convert_bounding_boxes_to_dict(
            augmented_lead_bbs, augmented_leadName_bbs, lead_bbs_labels, startTime_bbs, endTime_bbs, rotated_pixel_coordinates
        )
